"""
Django settings for cs_421_a1 project.
...
def parse_str_to_bool(text):
    return True if text and (text.lower() in ["yes", "true", "1"]) else False
...
WSGI_APPLICATION = "cs_421_a1.wsgi.application"
